...
/*   Updated: 2023/12/03 18:10:57 by gneto-co         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
        ...
        else if (i == '0')
        {
            ...
            while (a != 'q')
            {
                ...
                else if (a == 'r')
                {
                    ...
                    printf("\n\nInsert the amount of numbers you want in your stack\n:");
                    scanf(" %d", &nb);
                    char *str_args = "";
                    while (i2 < nb)
                    {
                    	fflush(stdout);
                        int random_nb;
                        random_nb = rand() % (2 * nb + 1) - nb;
                        
                        char *str_nb;
                        sprintf(str_nb, "%d", random_nb);
                        printf("\n%d - %s", i2, str_nb);                        
                        write(1, "aaa", 3);
                        ft_menu_strjoin(str_args, str_nb);
                        ft_menu_strjoin(str_args, " ");
