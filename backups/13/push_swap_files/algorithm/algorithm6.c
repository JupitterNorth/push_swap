...
/*   Updated: 2023/12/29 22:45:26 by gneto-co         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_push_chunks(t_list **stack_A, t_list **stack_B, int chunk_size, int exe, int moves_record)
{
	t_node_data	*data_A0;
	int	chunk_number;
	int i;
...
int	ft_algorithm_6(t_list **stack_A, t_list **stack_B, int chunk_size, int exe, int moves_record)
{
	int			moves;
	...
	moves = ft_push_chunks(&(*stack_A), &(*stack_B), chunk_size, exe, moves_record);
